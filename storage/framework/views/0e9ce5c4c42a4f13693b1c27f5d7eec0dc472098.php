                        ...
                        <table class="table table-dark mt-3">
                            <thead>
                                <tr>
                                    ...
                                    <td><?php echo e(__('language.COMMENT')); ?></td>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><img style="width:300px" src=<?php echo e(asset('img/comments/' . $item->images)); ?> alt="">
                                        <td>
                                            <a href="<?php echo e(route('editcomment', $item->id)); ?>" class="btn btn-primary"><i
                                                    class="fa-solid fa-pen-to-square"></i></a>
                                            <a href="<?php echo e(route('delcomment', $item->id)); ?>" class="btn btn-danger"><i
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\blog\resources\views/comment.blade.php ENDPATH**/ ?>
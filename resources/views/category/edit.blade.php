...
<div class="container">
    <div class="row">
        <div class="col-md-10 m-auto">
         <form enctype="multipart/form-data" action="{{route('updatecate')}}" method="post" >
            @csrf
                ...
                <input type="submit" value='{{__('language.EDITCATEGORY')}}' class="form-control btn btn-success">

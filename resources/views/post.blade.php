                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td>{{ $item->content }}</td>
                                        <td><img style="width:300px" src={{ asset('img/posts/' . $item->images) }} alt="">
                                        <td>
                                            <a href="{{ route('editpost', $item->id) }}" class="btn btn-primary"><i
                                                    class="fa-solid fa-pen-to-square"></i></a>
                                            <a href="{{ route('deletepost', $item->id) }}" class="btn btn-danger"><i
